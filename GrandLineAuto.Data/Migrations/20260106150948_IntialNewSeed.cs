...
{
    /// <inheritdoc />
    public partial class IntialNewSeed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Identification of the user profile"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Identification of the user id"),
                    FirstName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false, comment: "First name used for cheackout"),
                    LastName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false, comment: "Last name used for checkout"),
                    Phone = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    DefaultAddress = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
